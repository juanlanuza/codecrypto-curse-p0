...
// TestNet
//https://nodereal.io/
const web3 = new Web3('wss://bsc-testnet.nodereal.io/ws/v1/51b669d8367e41978ad32600d92d6ca7'); // nodereal
//const web3 = new Web3(new Web3.providers.HttpProvider('https://bsc-dataseed1.binance.org')); //  production
